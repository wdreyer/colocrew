...
export default SwipeableCardCamps = ({ item, removeCard, swipedDirection }) => {
    // spécifier le format de la date
    const dateFormat = "YYYY-MM-DDTHH:mm:ss:SSSZ";
    const [photo, setPhoto] = useState('http://tsr-industrie.fr/wp-content/uploads/2016/04/ef3-placeholder-image.jpg')
...
console.log(photo)
    ...
    return (
        ...
        >
            ...
            {item.activities &&
                item.activities.map((activitie, i) => {
                    return (
            ...
            <Text style={styles.disponibilities}>
               Séjour : du {dateFormater(item.startDate)} au {dateFormater(item.endDate)}
            </Text>
